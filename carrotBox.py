...
carrot in it. The first player looks into their box, and says,
\"There is a carrot in my box\" or \"There is no carrot on my box\".
The second player then gets to decide if they want to swap boxes to not.""")
...
print(p2Name + ', close your eyes and don\'t look!!!')
print()
...
if response.startswith('Y'):
    ...
    firsBox, secondBox = secondBox, firstBox
